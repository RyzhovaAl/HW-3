...
## Чfsffто такоgghrhе Git? 
## jjjkjkl;;

Git - одна  efegegge из реализаций распределённых систем контроля версий, имеющая как и локальные, так и удалённые репозитории. Является самой популярной реализjhjnjn jbheegege eцией систем контроля версий в мире.
ijjgpklkjbhvgvghnjnmkmk jhbhjnm kjnjkmnj j bhjnj
ojimnujikjhgbnm,lkjhgfdcvbhjk
gkgkgkgkg
